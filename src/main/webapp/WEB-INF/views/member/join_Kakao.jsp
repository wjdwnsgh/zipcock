			...
			<form name = "Ujoin" method="post" onsubmit="return joinValidate(this);" action='<c:url value="/member.do" />'>
				...
				<div>
					...
					<span class="box int_name"> 
						<input type="text" id="name" class="join_H" maxlength="20" name="member_name" value="${kakaoname }"> 
				...
				<div>
					...
					<span class="box int_id"> 
						<input type="text" id="id" class="join_H" maxlength="30" name="member_id" required value="${kakaoemail }"> 
